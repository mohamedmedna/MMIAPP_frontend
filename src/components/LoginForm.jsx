      ...
      <div className="login-container">
        <div className="login-form-wrapper">
          ...
          <p className="login-link">
           <Link to="/forgot-password" className="login-link">{t('loginform.forgot_password')}</Link>
          <span> | </span>
          <Link to="/inscription" className="login-link">{t('loginform.create_account')}</Link>
          </p>
          <Link to="/" className="login-back-home">← {t('loginform.back_home')}</Link>
        </div>
      </div>
      <Footer />
    </>
