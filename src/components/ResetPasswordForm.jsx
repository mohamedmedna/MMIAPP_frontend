          ...
          <div className="auth-box">
            <form className="auth-form" onSubmit={handleSubmit}>
              ...
              {token && (
                <>
                  <div className="form-group">
                    <label htmlFor="mot_de_passe" className="auth-label">{t('resetPassword.newPassword')}</label>
                    <input
                      id="mot_de_passe"
                      name="mot_de_passe"
                      type="password"
                  ...
                  <div className="form-group">
                    <label htmlFor="mot_de_passe2" className="auth-label">{t('resetPassword.confirmPassword')}</label>
                    <input
                      id="mot_de_passe2"
                      name="mot_de_passe2"
                      type="password"
                  ...
                  <button type="submit" className="auth-button">{t('resetPassword.submit')}</button>
                </>
              )}
              ...
              <div className="auth-links">
                <Link to="/login" className="register-link">{t('resetPassword.backToLogin')}</Link>
              </div>
            </form>
          </div>
        </div>
