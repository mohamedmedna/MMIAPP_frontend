        ...
        <div className="login-antd-form-container">
          ...
          >
            ...
            <Form.Item
              ...
              name="password"
              rules={[
                { required: true, message: t("loginddpi.error_password") },
              ]}
            >
              <Input.Password
                prefix={<LockOutlined />}
                placeholder={t("loginddpi.password")}
              />
            </Form.Item>
          ...
          <div className="login-antd-links">
            <Link to="/forgot-password" className="login-antd-link">
              {t("loginddpi.forgot_password")}
            </Link>
          </div>

          <Link to="/" className="login-antd-back-home">
            {t("loginddpi.back_home")}
          </Link>
        </div>
      </div>
