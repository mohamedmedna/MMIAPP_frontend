    ...
    <>
      ...
      <div className="login-container">
        ...
        <div className="login-intro">
          ...
          <Title level={3} style={{ color: '#229954' }}>{t('superAdminLogin.loginSpace')}</Title>
        </div>
        ...
        <div className="login-antd-form-container">
          ...
          >
            ...
            >
              <Input prefix={<UserOutlined />} placeholder={t('superAdminLogin.emailPlaceholder')} />
            </Form.Item>

            <Form.Item
              label={t('superAdminLogin.passwordLabel')}
              name="password"
              rules={[{ required: true, message: t('superAdminLogin.passwordRequired') }]}
            >
              <Input.Password prefix={<LockOutlined />} placeholder={t('superAdminLogin.passwordPlaceholder')} />
            </Form.Item>
          ...
          <div className="login-antd-links">
            <a href="/forgot-password" className="login-antd-link">{t('superAdminLogin.forgotPassword')}</a>
          </div>
          <a href="/" className="login-antd-back-home">← {t('superAdminLogin.backHome')}</a>
        </div>
      </div>
