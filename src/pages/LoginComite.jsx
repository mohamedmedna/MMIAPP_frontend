          ...
          >
            <Form.Item
              ...
              rules={[
                ...
                {
                  type: "email",
                  message: t("logincomite.error_email_invalid"),
                },
              ]}
            >
              <Input
                prefix={<UserOutlined />}
                placeholder={t("logincomite.email")}
              />
            </Form.Item>
            ...
            <Form.Item
              ...
              name="password"
              rules={[
                { required: true, message: t("logincomite.error_password") },
              ]}
            >
              <Input.Password
                prefix={<LockOutlined />}
                placeholder={t("logincomite.password")}
              />
            </Form.Item>
