    ...
    <div style={{ position: "relative" }}>
        ...
        <div className="form-section-usine">
          ...
          <div className="form-section-supplementaires">
            ...
            <div className="form-group">
              ...
              />
              <small className="field-help">
                Numéro national d'identité ou numéro de passeport
              </small>
            </div>
            ...
            <div className="form-group">
              ...
              />
              <small className="field-help">
                Précisez le sous-secteur d'activité
              </small>
            </div>
            ...
            <div className="form-group">
              ...
              />
              <small className="field-help">
                Décrivez l'activité principale de l'usine
              </small>
            </div>
            ...
            <div className="form-group">
              ...
              />
              <small className="field-help">
                Listez les filières concernées par votre activité
              </small>
            </div>
          </div>
        </div>
      ...
      {showPopup && (
        <div className="popup-success" onClick={() => setShowPopup(false)}>
          <div>
            <strong>{t("usine.thank_you")}</strong>
            <br />
            {t("usine.success_message_1")}
            <br />
