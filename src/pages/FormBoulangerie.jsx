      ...
      >
        ...
        <div className="form-section-juridique">
          <h4 className="section-title">
            📋 {t("boulangerie.dossier_juridique")}
          </h4>
        ...
        <div className="form-section-boulangerie">
          ...
          <div className="form-group">
            <label>
              📝 Une demande adressée au Ministre chargé de l'Industrie pour
              l'autorisation
            </label>
            <input
              type="file"
          ...
          <div className="form-group">
            <label>
              🆔 Une copie de la carte d'identité et des numéros de téléphone du
              propriétaire
            </label>
            <input
              type="file"
              name="carte_identite_proprietaire_file"
              accept=".pdf,.jpg,.png"
              onChange={handleFileChange}
              required
            />
          ...
          <div className="form-group">
            <label>
              🏠 Le titre de propriété foncière ou un contrat de bail d'une
          ...
          <div className="form-group">
            <label>
              📊 L'étude de faisabilité économique du projet (Boulangerie avec
              Pâtisserie ou Boulangerie ou Pâtisserie)
            </label>
            <input
              type="file"
          ...
          <div className="form-group">
            <label>
              📋 Une copie du cahier des charges des Boulangeries-Pâtisserie,
        ...
        <button
          type="submit"
          className="btn-form-boulangerie"
          disabled={loading}
        >
